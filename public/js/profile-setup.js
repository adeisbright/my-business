...
//Resume Display - Resume Feature 
const displayResume = board => {
    console.log("Testing the resume" , board)
}

window.addEventListener("load" , displayResume("ade")) 
selector = e => document.querySelector(e) 

const printer = selector("#print") 
...
printer.addEventListener("click" , handlePrint) 
